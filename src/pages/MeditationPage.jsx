            ...
            <article className="content-page">
                ...
                <div className="content-body">
                    ...
                    <section className="content-section">
                        ...
                        <p>
                            Baba Jaigurudev Ji Maharaj himself practiced Dhyan for eighteen hours a day after receiving spiritual initiation (Naamdaan) from his Guru, Ghurelal Ji Maharaj. By doing so, he 'opened the doors' of the spiritual realm, making this direct connection with God simple and attainable for ordinary people and householders today. However, it is emphasized that the specific method for performing these practices is revealed only by a true Saint. Currently, this spiritual guidance is being imparted by Baba Umakant Ji Maharaj. He suggested that at least 3 hours a day are required for spiritual practice, including 1 hour for meditation (Dhyan), 1.5 hours for Bhajan, and 30 minutes for Sumiran.
                        </p>
